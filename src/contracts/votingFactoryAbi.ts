export const votingFactoryAbi = [
  ...
  "function setRegistrar(address registrar, bool isAuthorized)",
  ...
  "function getVoteRecord(uint256 eventId, uint256 proposalId, address voter) view returns (bool voted)",
  ...
  "function getEventVoteCount(uint256 eventId) view returns (uint256)",
